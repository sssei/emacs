...

;;;### (autoloads nil "yasnippet-bundle" "yasnippet-bundle.el" (0
;;;;;;  0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yasnippet-bundle" '("yas/" "com" "dropdown-list" "define-key*" "snippet-mode" "last-buffer-undo-list")))
