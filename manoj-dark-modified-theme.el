...
(custom-theme-set-faces
 ...
 '(region ((t (:background "color-63" :foreground "#f6f3e8"))))
 ...
 '(font-lock-function-name-face ((t (:foreground "cyan" :weight bold :height 1.1))))
 '(font-lock-keyword-face ((t (:foreground "color-44"))))
 '(font-lock-negation-char-face ((t nil)))
 '(font-lock-preprocessor-face ((t (:foreground "color-25" :slant italic))))
 ...
 '(default ((t (:family "default" :foundry "default" :width normal :height 1 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "WhiteSmoke" :background "black" :stipple nil :inherit nil)))))
